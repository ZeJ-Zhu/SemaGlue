...
from gluefactory.models.segments.sync_bn.nn.modules import SynchronizedBatchNorm2d
...
norm_layer = partial(SynchronizedBatchNorm2d, momentum=float(default_config['SyncBN_MOM']))
...
class NormLayer(nn.Module):
    ...
    def __init__(self, inChannels, norm_type=default_config['norm_typ']):
        super().__init__()
...
class ConvBNRelu(nn.Module):
    ...
    def __init__(self, inChannels, outChannels, kernel=3, stride=1, padding='same',
        ...
        self.norm = NormLayer(outChannels, norm_type=default_config['norm_typ'])
