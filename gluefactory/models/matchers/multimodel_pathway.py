...
def reparameterize_aux_into_target_model(target_transformer, aux_transformer,
                               layer_names=('Wqkv', 'out_proj')):#, main_body_name='seg_tranformers'):
    ...
    #for target_block, aux_block in zip(target_transformer, aux_transformer):
    for layer_name in layer_names:
        change_original_linear_to_reparam(target_transformer, aux_transformer, layer_name)