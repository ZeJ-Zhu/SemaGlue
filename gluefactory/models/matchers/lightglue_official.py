...
class LightGlue(nn.Module):
    ...
    #def forward(self, view0: dict, view1: dict) -> dict:
        """
    ...
    def _forward(self, data: dict) -> dict:
        ...
        data0, data1 = data['view0']["image"], data['view1']["image"]
        ...
        # f_end_time = time.time() - f_time
        # print("f_end_time", f_end_time)
        # torch.cuda.synchronize()
        # l_time = time.time()
        for i in range(self.conf.n_layers):
        ...
        # torch.cuda.synchronize()
        # l_end_time = time.time() - l_time
        # print("l_end_time", l_end_time)
